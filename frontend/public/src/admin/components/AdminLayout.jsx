    ...
    <div className={`admin-shell${menuOpen ? ' admin-shell--menu-open' : ''}`}>
      ...
      <div className="admin-shell__main-col">
        ...
        <nav className="admin-shell__bottom" aria-label="Navigasi bawah">
          ...
          <NavLink to="/admin/arsip" className={({ isActive }) => `admin-shell__bottom-link${isActive ? ' active' : ''}`}>
            <IconArchive />
            <span>Arsip</span>
          </NavLink>

          <NavLink to="/admin/profil" className={({ isActive }) => `admin-shell__bottom-link${isActive ? ' active' : ''}`}>
            <IconUser />
            <span>Profil</span>
          </NavLink>
        </nav>
